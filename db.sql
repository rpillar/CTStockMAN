...
CREATE TABLE transactionData(channel TEXT, shopName TEXT, retrievalDate TEXT, start_date TEXT,end_date TEXT,scheduleDate TEXT, scheduleTime TEXT,processed INTEGER,transaction_count INTEGER);
